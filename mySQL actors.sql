...
SELECT last_name FROM actor WHERE last_name = '%GEN%';

-- 2c. Find all actors whose last names contain the letters LI. This time, order the rows by last name and first name, in that order:
SELECT last_name FROM actor WHERE last_name = '%LI%'ORDER BY last_name, first_name;
...
ALTER TABLE actor 
ADD COLUMN description BLOB(45) NULL AFTER first_name;
